...
function AddTeam({
  ...
  useEffect(() => {
    ...
    getData();
  }, [getPresets, match.params, getTeamMember]);
...
const mapstateToProps = state => ({
  ...
  member: state.users.currentMember
});
export default connect(
  mapstateToProps,
  { createTeamMember, getPresets, getTeamMember, updateTeamMember }
)(AddTeam);
